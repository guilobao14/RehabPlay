...
const planManagerText = {
  "pt-PT": {
    ...
    communicationTitle: "Comunicação e alertas",
    communicationText:
      "Acede rapidamente às mensagens e notificações da plataforma.",
  ...
  en: {
    ...
    communicationTitle: "Communication and alerts",
    communicationText: "Quickly access platform messages and notifications.",
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        const [patientsData, plansData, exercisesData, notificationsData] = await Promise.all([
          fetchTherapistPatients(),
          fetchPlans(),
          fetchExercises(),
        ...
        const safePlans = (Array.isArray(plansData) ? plansData : []).map(
          (plan) => {
            let patientId =
              plan.patient ??
              plan.patient_id ??
    ...
    <div className="appPage">
      <div className="appShellMockup">
        <div className="topbar">
          <Link to="/therapist/plans" className="brandLink" onClick={goToTop}>
            RehabPlay
          </Link>
        ...
        <main className="theraPlanPrimePage">
          <section className="theraPlanPrimeHeader">
            ...
            <div className="theraPlanPrimeHeaderRight">
              <div className="theraPlanMiniReminderCard">
                <div className="theraPlanMiniReminderTop">
                  <div className="theraPlanMiniReminderCounter">{unreadNotifications}</div>

                  <div>
                    <h3>{text.communicationTitle}</h3>
                    <p>{text.communicationText}</p>
                  </div>
                </div>

                <div className="theraPlanMiniReminderButtons">
                  <Link
                    to="/notifications"
                    className="theraPlanMiniBtn theraPlanMiniBtnPrimary"
                    onClick={goToTop}
                  >
                  ...
                  <Link
                    to="/messages"
                    className="theraPlanMiniBtn theraPlanMiniBtnGhost"
                    onClick={goToTop}
                  >
                    {text.goMessages}
                  </Link>
                    ...
                    {selectedPlan ? (
                      <div className="theraPlanPrimeDetailGrid">
                        ...
                        <div>
                          ...
                          <strong>
                            {selectedPlan.is_active ? text.active : text.inactive}
                          </strong>
                        </div>
